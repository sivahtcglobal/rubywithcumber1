@moodle
Feature: Moodle.User Story 11246: Database Template Viewed - Instructor Event

  @IntegrationTest @EndToEndTest
  Scenario: TC Instructor View the Database Template
    Given Instructor View the Database Template
    When The Database Template got successfully viewed by the Instructor
    Then An Event for Instructor Database Template Viewed should get generated and sent to our Raw Event Index.
