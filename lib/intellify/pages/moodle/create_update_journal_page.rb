class CourseJournalPage < BasePage

  #Moodle Create Journal Page Elements
  element(:journal_name_txt) { |b| b.text_field(id:"id_name")}
  element(:journal_description_txt) { |b| b.div(id:"id_introeditoreditable")}
  element(:days_available_select) { |b| b.select_list(id:"id_days")}
  ...
  #Submit Buttons
  element(:journal_cancel_btn) { |b| b.input(id:"id_cancel")}
  action(:journal_cancel_btn_clk) { |b| b.journal_cancel_btn.click }
  element(:journal_saveandreturncourse_btn) { |b| b.input(id:"id_submitbutton2")}
  action(:journal_saveandreturncourse_btn_clk) { |b| b.journal_saveandreturncourse_btn.click }
  element(:journal_saveanddisplay_btn) { |b| b.input(id:"id_submitbutton") }
  action(:journal_saveanddisplay_btn_clk) { |b| b.journal_saveanddisplay_btn.click }
