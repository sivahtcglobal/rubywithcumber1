@moodle
Feature: Moodle.User Story 11657: Game Viewed - Student Event

  @IntegrationTest @EndToEndTest
  Scenario: TC Student View the Game
    Given Student View the Game
    When The Game got successfully viewed by the Student
    Then An Event for Student Game Viewed should get generated and sent to our Raw Event Index.
    ...
    And ['event'].['object'].['extensions'].['moduleType'] = 'game_game'
