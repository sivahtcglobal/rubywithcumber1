@moodle
Feature: Moodle.User Story 11247: Database Template Updated - Instructor Event

  @IntegrationTest @EndToEndTest
  Scenario: TC Instructor Update the Database Template
    Given Instructor Update the Database Template
    When The Database Template got successfully updated by the Instructor
    Then An Event for Instructor Database Template Updated should get generated and sent to our Raw Event Index.
    ...
    And ['event'].['object'].['extensions'].['moduleType'] = 'data_template'
