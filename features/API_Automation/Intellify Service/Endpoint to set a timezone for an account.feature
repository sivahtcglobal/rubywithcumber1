...
Feature: 10547  Endpoint to set a timezone for an account
   - Add ability to set a timezone for an account in concierge API

  Scenario Outline: Endpoint to set a timezone for an account
    When Setting a new Timezone <timezone> for an account
    Then The Account should get updated with the new <timezone> Timezone
  ...
  Scenario: Should not allow invalid Timezone
      When Setting an invalid Timezone should not get updated to the account