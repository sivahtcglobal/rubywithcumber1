@moodle
Feature: Moodle.User Story 11318: Choice Report Viewed - Instructor Event

  @IntegrationTest @EndToEndTest
  Scenario: TC Instructor View the Choice Report
    Given Instructor View the Choice Report
    When The Choice Report got successfully viewed by the Instructor
    Then An Event for Instructor Choice Report Viewed should get generated and sent to our Raw Event Index.
    ...
    And ['event'].['object'].['extensions'].['moduleType'] = 'choice_report'
