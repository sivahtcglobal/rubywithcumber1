...
element(:org_address_ip){|b| b.text_field(id:"accountOwner.companyAddress")}
  element(:org_save){|b| b.div(class:"text-right col-sm-4 col-xs-offset-8").button(text:"Save")}
...
element(:acc_name_ip){|b| b.text_field(id:"accountContact.name")}
element(:acc_title_ip){|b| b.text_field(id:"accountContact.title")}
    element(:acc_email_ip){|b| b.text_field(id:"accountContact.email")}
        ...
        element(:acc_save){|b| b.div(class:"text-right col-sm-4 col-xs-offset-8",index:1).button(text:"Save")}
...
element(:tech_name_ip){|b| b.text_field(id:"technicalContact.name")}
...
element(:tech_save){|b| b.div(class:"text-right col-sm-4 col-xs-offset-8",index:2).button(text:"Save")}
            end